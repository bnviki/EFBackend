...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            extras: {
                src: ['public/js/lib/xeditable.min.js', 'public/js/lib/strophe.min.js', 'public/js/lib/jquery.slimscroll.min.js', 'public/js/lib/bootstrap/jasny-bootstrap.min.js', 'public/build/ang.min.js'],
